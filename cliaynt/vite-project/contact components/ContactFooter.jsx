            ...
            <footer className="main-footer">
                            ...
                            <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
                                <div className="info-inner">
                                    <div className="content">
                                        ...
                                        <div className="text">Email us: <br />
                ...
                <div className="auto-container">
                    <div className="footer-bottom">
                        <div className="copyright-text">© Copyright <a href="#">Fuad Tech</a> 2020. All rights are reserved.</div>
                        <div className="text">Created by Fuad <a href="#">ThemeArc</a></div>
                    </div>
                </div>
            </footer>
        </div>
