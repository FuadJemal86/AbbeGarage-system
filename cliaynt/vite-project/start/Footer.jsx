...
<footer className="main-footer">
                            ...
                            <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
                                <div className="info-inner">
                                    <div className="content">
                                        ...
                                        <div className="texts">Call us on: <br /><strong>+ 251 902 9203 01</strong></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="auto-container">
                    <div className="footer-bottom">
                        <div className="copyright-texts texts">© Copyright <a href="#">Fuad Tech</a> 2024. All rights are reserved.</div>
                    </div>
                </div>
            </footer>
